...
from fakepred.celery.common import CELERY_SEARCHER_TASK
from fakepred.celery_searcher.celery_app import app
from fakepred.celery_searcher.celery_worker import WorkerState
...
from fakepred.scrapper.model import Entry, SearchedNews
